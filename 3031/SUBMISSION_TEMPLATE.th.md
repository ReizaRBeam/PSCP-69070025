...
```text
รับค่าเข้ามา แล้วคำนวนระยะห่างของจุดที่ต้องการหาใช้เป็นรัศมี เพื่อใช้คำนวนเป็นพื้นที่ของวงกลม แล้วหารด้วยพื้นที่ที่ขยายออกไปทุกๆวินาทีที่ให้มา จะได้ออกมาเป็นจำนวนวินาที แล้วแสดงผลเวลาออกมา
```
...
```text
Step 1:รับค่าเข้ามา
Step 2:แล้วคำนวนระยะห่างของจุดที่ต้องการหาใช้เป็นรัศมี เพื่อใช้คำนวนเป็นพื้นที่ของวงกลม แล้วหารด้วยพื้นที่ที่ขยายออกไปทุกๆวินาทีที่ให้มา จะได้ออกมาเป็นจำนวนวินาที
Step 3:แสดงผลเวลาออกมา
```
