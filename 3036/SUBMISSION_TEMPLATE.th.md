...
```text
รับค่าช่องเข้ามา แล้วมาหาแถวที่เลขนั้นอยู่ แล้วคำนวนกำแพงที่ต้องผ่าน
```
...
```text
Step 1:รับค่าช่องเข้ามา
Step 2:หาแถวที่เลขนั้นอยู่
Step 3:คำนวนกำแพงที่ต้องผ่าน
```
...
```text
เหมือนแผนแรก เพราะลองแล้วได้จริง
```
