...
```text
รับอินพุตราคามีเป็นint
คำนวนหาค่าบริการ แล้วเอามาเข้าเงื่อนไข หากน้อยกว่า50 จะปรับเป็น50 ถ้ามากกว่า1000 จะปรับเป็น1000
เพิ่มเข้าไปในราคาต้น
คำนวนเอาราคารวมค่าบริการคูณด้วย1.07จากภาษี7%
แสดงผล
```
...
```text
Step 1:รับอินพุตราคามีเป็นint
Step 2:คำนวนหาค่าบริการ แล้วเอามาเข้าเงื่อนไข หากน้อยกว่า50 จะปรับเป็น50 ถ้ามากกว่า1000 จะปรับเป็น1000
Step 3:เพิ่มเข้าไปในราคาต้น
Step 4:คำนวนภาษี7%แล้วค่อยเอาไปรวม
Step 5:คำนวนราคาสุดท้าย
Step 6:แสดงผล
```
...
```text
เหมือนแผนแรก เพราะมันใช้ได้เลยไม่ติดอะไร ไม่ต้องแก้อะไรเพิ่มด้วย
```
