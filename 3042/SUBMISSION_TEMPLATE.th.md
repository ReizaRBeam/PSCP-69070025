...
```text
ให้รับค่า แล้วรันลดไปเรื่อยๆจนเจอตัวที่หารด้วย10ลงตัว แล้วแสดงผลแล้ววน-10ไปเรื่อยๆแล้วแสดงผล จนกว่าจะเป็น0
```
...
```text
Step 1:ให้รับค่า
Step 2:รันลดไปเรื่อยๆจนเจอตัวที่หารด้วย10ลงตัว
Step 3:แสดงผลแล้ววน-10ไปเรื่อยๆแล้วแสดงผล จนกว่าจะเป็น0
```
...
```text
เหมือนแผนแรก เพราะดูทำได้ง่ายที่สุด และใช้ได้จริงแล้ว
```
